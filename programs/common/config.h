...
// All of these are iteration counts, so every one is back to its 50 MHz value
// now that the pipeline runs the CPU domain at CLOCK_50 with no divider. The
// wall clock times are unchanged.
